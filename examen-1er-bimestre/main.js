...
function clasificar(clasificacion, arreglo, nombrePropiedad) {
    const respuesta = [];
    clasificacion
        .forEach((nombre) => {
...
function buscarAbecedario(abecedario, arreglo) {
    const respuesta = [];
    abecedario
        .forEach((letra) => {
...
function massHeight(arreglo, nombrePropiedad) {
    return arreglo
...
function calcularSiExiste(arreglo, nombrePropiedad) {
    return arreglo
        .every((caracter) => {
...
function hanParticipado(arreglo) {
    return arreglo
        .map((caracter) => {
        return {
